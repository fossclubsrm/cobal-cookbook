...
Read 10 integers, compute the sum, average, minimum, and maximum.
...
| --- | --- | --- |
| Lines of code | 48 | 9 |
| Variable declaration | Required with PIC clauses | Dynamic |
| Loop syntax | `PERFORM VARYING` | List comprehension |
| Input handling | `ACCEPT` per line | `input()` per line |
| Output formatting | PIC editing and `DISPLAY` | f-strings |
| Type safety | Strict, defined data items | Dynamic, runtime values |
